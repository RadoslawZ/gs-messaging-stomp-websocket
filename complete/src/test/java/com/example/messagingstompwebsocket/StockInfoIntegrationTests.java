...
public class StockInfoIntegrationTests {
    ...
    public void getStockInfo() throws Exception {
        ...
        StompSessionHandler handler = new TestSessionHandler(failure) {
            ...
            public void afterConnected(final StompSession session, StompHeaders connectedHeaders) {
                session.subscribe("/topic/stockinfos", new StompFrameHandler() {
                    @Override
                ...
                try {
                    session.send("/app/stockinfo.start", "");
                } catch (Throwable t) {
                    failure.set(t);
                    latch.countDown();
                }
        ...
        if (latch.await(3, TimeUnit.SECONDS)) {
            ...
            fail("Expected web socket message not received!");
        }
