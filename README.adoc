...
== DEMO: How to launch the demo of repetitive push of Stock Info with prices

Please change to complete folder:
====
[source,json]
----
$ cd complete
...
First, click the 'Connect' button then the 'Send' button - it causes the server of application to push notifications to the web client (the page).
